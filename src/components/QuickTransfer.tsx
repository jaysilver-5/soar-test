  ...
  return (
    <div className="flex justify-between flex-col 3xl:w-[445px] 3xl:h-[276px] w-full bg-white h-[195px] items-center rounded-[25px] 3xl:py-10 3xl:px-6 p-5 relative">
          ...
          {users.map((user) => (
            ...
            >
              ...
              <div className="flex flex-col items-center justify-center">
                <h3 className="text-[#232323] font-normal font-primary 3xl:text-[16px] text-[12px]">
                  {user.name}
                </h3>
                <p className="text-[#718EBF] font-normal font-primary 3xl:text-[16px] text-[12px] 3xl:leading-[18px] leading-[15px]">
                  {user.role}
                </p>
              </div>
            </div>
      ...
      <div className="w-full flex justify-between items-center">
        <h1 className="3xl:text-[16px] text-[12px] text-[#718EBF]">
          Write Amount
        </h1>
